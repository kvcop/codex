...
pub(crate) struct ChatWidget {
    ...
    reset_usage_request_in_flight: Option<ResetUsageAttempt>,
    reset_usage_retry: Option<ResetUsageAttempt>,
    pending_reset_usage_refresh: Option<reset_usage::PendingResetUsageRefresh>,
